...
(function ($) {
	...
	var methods = {
		...
		tableWidget: function (mode) {
			...
			var tblCntr = $('<div/>', { //Outer Container Div
				...
				class: "col-xs-12 col-sm-6 col-md-6 col-lg-6"
			}).append($('<label/>', { for: "tblRows" + idExtn, text: "Rows", class: "form-control-width" }
							)).append($('<input/>', {
								id: "tblRows" + idExtn,
								type: "text",
								class: "form-control-insert-table form-control-width",
								value: 2
							})).append($('<div/>', { 
							}).append($('<label/>', { for: "tblColumns" + idExtn, text: "Columns",class:"form-control-width" }
							)).append($('<input/>', {
							...
							}).append($('<label/>', { for: "tblWidth" + idExtn, text: "Width", class: "form-control-width" }
							)).append($('<input/>', {
								id: "tblWidth" + idExtn,
								type: "text",
								class: "form-control-insert-table form-control-width",
								value: 400
							}))).append($('<label/>', { for: "tblHeight" + idExtn, text: "Height", class: "form-control-width" }
							)).append($('<input/>', {
								id: "tblHeight" + idExtn,
								type: "text",
								class: "form-control-insert-table form-control-width",
							...
							class: "col-xs-12 col-sm-6 col-md-6 col-lg-6"
						}).append($('<label/>', { for: "tblAlign" + idExtn, text: "Alignment", class: "form-control-width" }
							)).append($('<select/>', { id: "tblAlign" + idExtn, class: "form-control-insert-table form-control-width" }
							...
							}).append($('<label/>', { for: "tblBorder" + idExtn, text: "Border size", class: "form-control-width" }
							)).append($('<input/>', {
								id: "tblBorder" + idExtn,
								type: "text",
								class: "form-control-insert-table form-control-width",
								value: 1
							}))).append($('<label/>', { for: "tblCellspacing" + idExtn, text: "Cell spacing", class: "form-control-width" }
							)).append($('<input/>', {
							...
							}).append($('<label/>', { for: "tblCellpadding" + idExtn, text: "Cell padding", class: "form-control-width" }
							)).append($('<input/>', {
		...
		init: function (options) {
		  ...
		  "Wingdings":"wingdings,zapf dingbats"
			...
			var id="Container_" + $(this).attr("id")
			//var editor = $(' <div id="' + id + '" class="Editor-editor" style="overflow:auto" contenteditable="true" ng-keyup="ngKeyup()"><div />')
			//    .appendTo(containerDiv);
			var editor = $("<div />", {
				id: "Container_" + $(this).attr("id"),
				class: "Editor-editor",
				css: { overflow: "auto" },
			...
			if (settings['status_bar']) {
				editor.keyup(function (event) {
					...
					$(editor_Content).data("statusBar").append('<div class="label" id="'+$(this).attr("id")+ 'CharCnt" >' + 'Characters : ' + charCount + '</div>');
					$(editor_Content).data("statusBar").append('<div class="label" >' + 'Remaining Characters : ' + (100000 - charCount) + '</div>');
				});
			}
	...
	$.fn.GetEditorTotalCharCount = function (method) {
		return methods.countChars.apply(this, [$(this).data("editor")]);
	};
